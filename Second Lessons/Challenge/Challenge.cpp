...
Lesson Pseudo Code:
    Prompt user to enter the number of small rooms
    Prompt user to enter the number of large rooms
    Display number of small rooms
    Display number of large rooms
    Display price per small rooms   
    Display price per large rooms   

    Display cost: (number of small rooms * price per small room) + (number of small rooms * price per small room)
    Display tax: (number of small rooms * price per small room) + (number of small rooms * price per small room) * tax rate
    Display total estimate: (number of small rooms * price per small room) + (number of small rooms * price per small room) + (number of small rooms * price per small room) * tax rate
